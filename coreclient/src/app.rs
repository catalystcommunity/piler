//! The whole client application: UI state machine, input handling, and
//! rendering — entirely in the framebuffer (no DOM). The host forwards key
//! events, tunnels WebSocket bytes, and blits the framebuffer.
//!
